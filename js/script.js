...
const translations = {
  de: {
    ...
    "hero.eyebrow": "Porträts · Love Story · Familie · Fashion · Art · Hochzeiten · Events · Baby Bauch · Business",
    "hero.titleGradient1": "Licht",
    "hero.title1": "und Emotion",
    "hero.title2": "in jedem",
    "hero.titleGradient2": "Foto",
    "hero.subtitle": "Ich fotografiere Geschichten, die man immer wieder ansehen möchte. Bei Dream Lights Photos bekommst du nicht einfach nur Bilder – du erlebst einen Raum für echte Emotionen. Mein Blick ist persönlich und das Shooting ein Moment, an den du dich genauso gerne erinnerst wie an das Ergebnis.",
    ...
    "gallery.maternity1": "Baby Bauch · Porträt",
    ...
    "service2.desc": "Romantische Paarfotos an deinem Lieblingsort – authentisch und stimmungsvoll.",
    ...
    "service9.title": "Baby Bauch",
    "service9.desc": "Einfühlsame Fotos für deine wertvolle Wartezeit.",
    ...
    "contact.desc": "Hinterlasse eine Anfrage — ich melde mich innerhalb eines Tages, um die Details zu besprechen.",
    "contact.location": "Bern · im Einsatz in der ganzen Schweiz",
    "form.name": "Name",
    "form.namePh": "Wie heißt du?",
    "form.phone": "Telefon",
    ...
    "form.type7": "Fashion",
    "form.type8": "Art",
    "form.type10": "Baby Bauch",
    "form.type11": "Business",
    "form.message": "Nachricht",
    "form.messagePh": "Erzähl mir kurz von deinem Shooting...",
    ...
    "form.error": "Bitte fülle alle rot markierten Pflichtfelder aus.",
  ...
  en: {
    ...
    "hero.eyebrow": "Portraits · Love Story · Family · Fashion · Art · Weddings · Events · Baby Bump · Business",
    ...
    "gallery.maternity1": "Baby Bump · Portrait",
