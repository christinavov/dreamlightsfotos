...
const translations = {
  de: {
    ...
    "hero.eyebrow": "Porträts · Love Story · Familie · Fashion · Art · Hochzeiten · Events · Landschaft & Natur · Schwangerschaft · Business",
    "hero.title1": "Zwischen Licht und Schatten —",
    "hero.title2": "deine ehrlichsten",
    "hero.titleGradient": "Emotionen",
    ...
    "about.desc1": "Die Fotografie ist für mich nicht nur ein Beruf, sondern meine größte Leidenschaft – und das schon seit über 10 Jahren. In dieser Zeit habe ich gelernt, dass jedes Bild seine eigene Geschichte erzählt.",
  ...
  en: {
    ...
    "hero.eyebrow": "Portraits · Love Story · Family · Fashion · Art · Weddings · Events · Landscape & Nature · Maternity · Business",
    "hero.title1": "Between light and shadow —",
    "hero.title2": "your most honest",
    "hero.titleGradient": "emotions",
    ...
    "about.desc1": "Photography isn't just a job for me — it's been my greatest passion for over 10 years. In that time I've learned that every picture tells its own story.",
