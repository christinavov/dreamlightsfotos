...
const translations = {
  de: {
    ...
    "services.note": "Hinweis: Die Studiomiete wird separat verrechnet und ist im Paketpreis nicht inbegriffen.",
  ...
  en: {
    ...
    "services.note": "Please note: studio rental is billed separately and is not included in the package price.",
